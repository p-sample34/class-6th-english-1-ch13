async function loadQuestions() {
  try {
    ...
    const res = await fetch('https://class-6th-english-1-ch13.onrender.comhttps://class-6th-english-1-ch13.onrender.com/questions');
    if (!res.ok) {
...
async function submitAnswers() {
  ...
  try {
    ...
    const res = await fetch('https://class-6th-english-1-ch13.onrender.com/submit-answers', {
      method: 'POST',
